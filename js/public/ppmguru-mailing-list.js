...
jQuery(document).ready(function($){
	...
	var wpajax_url = document.location.protocol + '//' + document.location.host + '/wordpress-plugin-course/wp-admin/admin-ajax.php';
	
	// email capture action url
	var email_capture_url = wpajax_url += '?action=pgm_save_subscription';
	
	$('form.pgm-form').bind('submit',function(){
